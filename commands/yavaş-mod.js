...
if(args[0] > 21600) return message.channel.send(new Discord.MessageEmbed().setColor('9c5cb2').setDescription(`${message.author} Yavaş mod için (\`max.21600\`) saniye girilebilirsin! 🤔
